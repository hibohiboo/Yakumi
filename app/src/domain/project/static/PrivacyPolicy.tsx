  ...
  return (
    <BaseWrapper>
      ...
      >
        ...
        <h2>個人情報の利用目的</h2>
        <p>
          当サイトでは、キャラクターシートの登録などの際に、名前（ハンドルネーム）、Google連携等の個人情報をご登録いただく場合がございます。
        </p>
        <p>
        ...
        <h2>アクセス解析ツールについて</h2>
        <p>
          当サイトでは、忍者ツールズ株式会社よるアクセス解析ツール「忍者アクセス解析」を利用しています。このGoogleアナリティクスはトラフィックデータの収集のためにCookieを使用しています。
          このトラフィックデータは匿名で収集されており、個人を特定するものではありません。
          この機能はCookieを無効にすることで収集を拒否することが出来ますので、お使いのブラウザの設定をご確認ください。
          このサービスに関連するプライバシーポリシーやCookieについての詳細は、
          <a
            target="_blank"
            href="https://www.ninja.co.jp/"
